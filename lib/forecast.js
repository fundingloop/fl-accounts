...
//    the fast-forward loop steps 2026-06-01 -> 2026-07-01 (>= today), and
//    that becomes the first projected occurrence - matches "include
//    occurrences from today up to the horizon", not the stale June date.
//
// 3) Same bill but paid=true (anchor settled): occurrence starts at
//    stepRecurrence(2026-06-01, 'monthly') = 2026-07-01 before the
//    fast-forward loop even runs - the next occurrence, as specified.
//
